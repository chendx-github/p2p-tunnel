...
namespace client.service.tcpforward
{
    ...
    public class TcpForwardTransfer : TcpForwardTransferBase
    {
        ...
        {
            var resp = await tcpForwardMessengerSender.GetPorts(registerStateInfo.UdpConnection);
        ...
        {
            var resp = await tcpForwardMessengerSender.Register(registerStateInfo.UdpConnection, new TcpForwardRegisterParamsInfo
            {
        ...
        public async Task<string> StopServerForward(ServerForwardItemInfo forward)
        {
            ...
            var resp = await tcpForwardMessengerSender.UnRegister(registerStateInfo.UdpConnection, new TcpForwardUnRegisterParamsInfo
            {
                AliveType = forward.AliveType,
                SourceIp = forward.Domain,
                SourcePort = forward.ServerPort,
